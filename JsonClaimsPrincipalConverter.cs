...
namespace Integrations.HKTDC.Webforms.Middleware
{
    public class JsonClaimsPrincipalConverter : JsonConverter
    {
        ...
        public override void WriteJson(JsonWriter writer, object value, JsonSerializer serializer)
        {
            ...
            {
                {
                    nameof(ClaimsPrincipal.Identities),
                    new JArray(claimsPrincipal.Identities.Select(x => JObject.FromObject(x, serializer)))
                }
            };
